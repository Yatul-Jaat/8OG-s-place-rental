...
import { HandleSignup } from "../../../Hooks/ConsumerSignup";
    ...
    <div className="h-screen w-screen flex justify-center items-center z-10 ">
      <div className=" bg-white flex flex-col justify-center items-center rounded-4xl border-1 border-gray-100 shadow-2xl">
        ...
        >
          ...
          <NavLink to="/" className="absolute text-xl left-5 font-semibold  h-6 w-6 rounded-full cursor-pointer">
            <RxCross2  />
          </NavLink>
        ...
        >
          ...
          <button
            type="submit"
            className={`w-full bg-red-400 py-3 text-xl text-white rounded-xl ${loading? "cursor-progress":"cursor-pointer"}`}
          >
            Continue
          </button>
        </form>
